9#Physics #Barton #Quantum #commutator #Quantum_Compution #Pauli_matrices #matrix_representation #Schrodinger_Equation #3-D_Schrodinger
...
Pauli matrices: $\sigma_{1}=\left(\begin{array}{ll}0 & 1 \\ 1 & 0\end{array}\right), \sigma_{2}=\left(\begin{array}{cc}0 & -i \\ i & 0\end{array}\right),\sigma_{3}=\left(\begin{array}{cc}1 & 0 \\ 0 & -1\end{array}\right)$
...
And the problem is these matrices have to be infinite dimensional. <mark style="background: #55C5B2;">It's impossible to find two finite matrices whose commutator gives you a number.</mark>
