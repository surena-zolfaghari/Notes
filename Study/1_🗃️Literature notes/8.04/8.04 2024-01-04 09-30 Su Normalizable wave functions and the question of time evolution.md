...
The limit may exist and it may be a number, But is not infinite. And in every example that I know, in fact when $(2)$ goes to zero, $(3)$ goes to zero. <mark style="background: #FF2C61;">And it's all you need to do integration.
</mark>

You shouldn't be too surprised that you need to $(3)$ about this wave function, because we have two derivative in $(*)$. So when we manipulate the right hand of equality in $(*)$ inside the integrals, <mark style="background: #55C5B2;">you will see single derivatives will blow up and we will have to control them.</mark>
