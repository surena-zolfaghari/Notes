...
Quantum mechanics is really a framework to do physics. and correct the description of fundamental theory.  Quantum physics is the principles of QM applied to different physical phenomena. For example:
...
When You have a theory, Yow have some dynamical variables. These are the variables you want to find their values because they are connected with observation. 
