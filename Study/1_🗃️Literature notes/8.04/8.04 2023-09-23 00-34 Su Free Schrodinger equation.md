#Physics #Barton #Quantum #Schrodinger_Equation #free_particle #superposition #wave_function #group_velocity #wave 
...
$$
\begin{aligned}
&\Rightarrow \underbrace{\hbar \omega=\frac{h^{2} k^{2}}{2 m}}_{\text{relation between $k$ and $\omega$}\;(3)}\\
&\Rightarrow E=\frac{p^{2}}{2 m}
\end{aligned}
$$
