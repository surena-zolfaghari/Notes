#Physics #Barton #Quantum #Max_Born #Schrodinger_Equation #Interpretation_of_wave_function #Normalization  
...
$$
\int_{\text {all over space }} d^{3} x\left|\psi\left(x, t_{0}\right)\right|^{2}=1
\tag{*}$$
